...
void CamReset() {
    ...
    CamWrite(0x18, 0x43); // HREFEND[10:3] (CIF)
    CamWrite(0x19, 0x00); // VSTRT[9:2] (CIF)
    CamWrite(0x1a, 0x97); // VEND[9:2] (Default)
    CamWrite(0x32, 0x09); // Bit[5:3]: HREFEND[2:0]; Bit[2:0]: HREFST[2:0] (CIF)
    CamWrite(0x03, 0x06); // Bit[3:2]: VEND[1:0]; Bit[1:0]: VSTRT[1:0] (CIF)
